                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li>
                                  <a href="Producto.php" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main">Registrar Producto</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                              </li>
                                      </li>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10">Editar Productos:</h4>
                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <?php $resultado = mysqli_query($conexion, $producto);
                                                        ...
                                                        <form class="form-material" action="Actualizar.php" method="POST" >
                                                            <div class="form-group form-default">
                                                                <input type="text" name="id" value="<?php echo $row["id"]; ?>" title='ID' class="form-control"  readonly>
                                                                <span class="form-bar"></span>
                                                                
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <input type="text" name="pro" value="<?php echo $row["producto"]; ?>" title='Producto' class="form-control" required>
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Producto:</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <input type="text" name="des" value="<?php echo $row["descripcion"]; ?>" title='Descripcion' class="form-control" required>
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Descripcion:</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <input type="text" name="pre" value="<?php echo $row["precio"];  ?>" title='Precio' class="form-control" required>
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Precio:</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <input type="text" name="can" value="<?php echo $row["cantidad"]; ?>" title='Cantidad' class="form-control" required>
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <div class="col-md-12">
                                                                <button type="submit" onclick="return editpro()" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Actualizar</button>
                                                            </div>
