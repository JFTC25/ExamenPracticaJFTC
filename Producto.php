                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h4 class="m-b-10">Registrar Productos</h4>
                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <form class="form-material" action="DatosProducto.php" method="POST" >
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="text" name="can" class="form-control" required>
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Cantidad:</label>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Registrar</button>
                                                            </div>
