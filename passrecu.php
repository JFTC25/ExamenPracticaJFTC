            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" method="POST" action="reinicio.php" >
                            ...
                            <div class="auth-box card">
								...
								if(isset($_GET['estado'])){
									...
									if($estado==2){	?>
									<div class="col-md-12">
                                        <button class="btn waves-effect waves-light btn-danger btn-outline-danger btn-primary btn-md btn-block text-center m-b-20"><i class="ti-close"></i></i>Usuario o Correo no coinciden</button>
									</div>
									<?php		
									}
								...
								?>
                                    ...
                                    <div class="form-group form-primary">
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Recuperar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
