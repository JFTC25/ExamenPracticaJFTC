                                            ...
                                            <!--  project and team member start -->
                                             <div class="col-sm-12">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th colspan="3" class="text-center" >Datos Usuario</th>
                                                               <?php if(isset($_GET['estado'])){
								                                $estado=$_GET['estado'];
									                            if($estado==1){	?>
									                                <div class="col-md-12">
                                                                    <button class="btn waves-effect waves-light btn-success btn-outline-success btn-primary btn-md btn-block text-center m-b-20"><i class="icofont icofont-user-alt-3"></i>Cambio de Contraseña Exitoso</button>
                                                                    </div>
                                                                    <?php		
                                                                    }
                                                                    if($estado==2){	?>
                                                                    <div class="col-md-12">
                                                                        <button class="btn waves-effect waves-light btn-danger btn-outline-danger btn-primary btn-md btn-block text-center m-b-20"><i class="ti-close"></i></i>Las Contraseña no coinciden</button>
                                                                    </div>
                                                                    <?php		
                                                                    }	}?>
                                                            </tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                            <th scope="row" rowspan="4" class='table-info'> <img class="img-110"  src="assets/images/G2.png" ></th>
                                                            </tr>
                                                            <tr class="table-active">
                                                                <td>Usuario:</td>
                                                                <td colspan="2"><?php echo $row["usuario"]; ?></td>
                                                                <td> </td>
                                                            ...
                                                            <tr class="table-success">
                                                                <td>Contraseña:</td>
                                                                <td colspan="2"><?php echo  $row["pass"]; ?><br> (Contraseña Codificada)</td>
                                                                <td> </td>
                                                            ...
                                                            <td colspan="2">
                                                            <?php 
                                                                $te = "SELECT * FROM usuario WHERE usuario= '$user'";
                                                                $pol = mysqli_query($conexion, $te);
                                                                while ($re=mysqli_fetch_assoc($pol)) { 
                                                                 echo "<a href='repass.php?id=".$re['id']."'><button class='btn btn-primary btn-round waves-effect waves-light'>Cambiar Contraseña</button></a>"; }?></td>
                                                    ...
                                                    </table><h6 class="text-center">JFTC :v</h6>
                                                </div>
                                            </div>
                                        </div>
